describe("REST Assured approach API testing", () => {
  context("Given I have access to bookings page", () => {
  ...
  context("When I Create New Booking in the system", () => {
    it("Then the new booking entry should be added in the system", () => {
      cy.request({
        ...
        expect(resp.body.booking.firstname).to.eq("Kelvin");
        expect(resp.body.booking.lastname).to.eq("May");
  ...
  context("When I Edit New Booking which i just created in the system", () => {
